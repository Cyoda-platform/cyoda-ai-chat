...
class RandomProcessor(RagProcessor):
    ...
    def image_description(self, image_file, mime_type) -> str:
        ...
        question = "Please give me maximum information from this image. Return no less than 70 words. If it is a diagram, you can return Markup text, which correctly describes relations and connections in this data. Provide as much relevant information as possible."
