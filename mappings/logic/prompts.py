...
MAPPINGS_DEFAULT_PROMPTS=["analyze the script and add all missing inputSrcPaths (they should be available for all input attributes used in the script). Use slash \"/\" for the jsonpath.",
