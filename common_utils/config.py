...
LLM_MODEL_ADD_SCRIPT = get_env_var("LLM_MODEL_ADD_SCRIPT_CYODA") if CYODA_APP_NAME.lower() == "cyoda" else get_env_var("LLM_MODEL_ADD_SCRIPT_COBI")
...
LLM_MODEL_CYODA_API_BASE = get_env_var("LLM_MODEL_CYODA_API_BASE", None)
...
LLM_MODEL_RANDOM_API_BASE = get_env_var("LLM_MODEL_RANDOM_API_BASE", None)
